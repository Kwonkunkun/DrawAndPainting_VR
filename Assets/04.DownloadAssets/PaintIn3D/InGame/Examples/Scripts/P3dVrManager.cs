...
namespace PaintIn3D.Examples
{
	...
	public class P3dVrManager_Editor : P3dEditor<P3dVrManager>
	{
		protected override void OnInspector()
		{
			...
			BeginDisabled();
				EditorGUILayout.Toggle("Left Trigger", Target.LeftTrigger);
				EditorGUILayout.Toggle("Left Grip", Target.LeftGrip);
				EditorGUILayout.Toggle("Right Trigger", Target.RightTrigger);
				EditorGUILayout.Toggle("Right Grip", Target.RightGrip);
			EndDisabled();
		}
	}
}

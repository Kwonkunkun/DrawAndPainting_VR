...
namespace PaintIn3D
{
	...
	{
		public static P3dBlendMode AlphaBlend(Vector4 channels) { return new P3dBlendMode() { Index = ALPHA_BLEND, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode AlphaBlendInverse(Vector4 channels) { return new P3dBlendMode() { Index = ALPHA_BLEND_INVERSE, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode Premultiplied(Vector4 channels) { return new P3dBlendMode() { Index = PREMULTIPLIED, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode Additive(Vector4 channels) { return new P3dBlendMode() { Index = ADDITIVE, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode AdditiveSoft(Vector4 channels) { return new P3dBlendMode() { Index = ADDITIVE_SOFT, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode Subtractive(Vector4 channels) { return new P3dBlendMode() { Index = SUBTRACTIVE, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode SubtractiveSoft(Vector4 channels) { return new P3dBlendMode() { Index = SUBTRACTIVE_SOFT, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode Replace(Vector4 channels) { return new P3dBlendMode() { Index = REPLACE, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode ReplaceOriginal(Vector4 channels) { return new P3dBlendMode() { Index = REPLACE_ORIGINAL, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode ReplaceCustom(Color color, Texture texture, Vector4 channels) { return new P3dBlendMode() { Index = REPLACE_CUSTOM, Color = color, Texture = texture, Channels = channels }; }
		public static P3dBlendMode MultiplyInverseRGB(Vector4 channels) { return new P3dBlendMode() { Index = MULTIPLY_INVERSE_RGB, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode Blur(Vector4 channels) { return new P3dBlendMode() { Index = BLUR, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode NormalBlend(Vector4 channels) { return new P3dBlendMode() { Index = NORMAL_BLEND, Color = Color.white, Channels = channels }; }
		public static P3dBlendMode NormalReplace(Vector4 channels) { return new P3dBlendMode() { Index = NORMAL_REPLACE, Color = Color.white, Channels = channels }; }
